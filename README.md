...
- [Frontend](https://github.com/empty0845/DetectXiaoZhuan-WeChat.git): The front-end interface that allows users to interact with the results generated by the backend's pre-trained model.
- [Backend](https://github.com/empty0845/DetectXiaoZhuan-Backend.git): The backend service that runs the pre-trained model and exposes the results to the front-end.
